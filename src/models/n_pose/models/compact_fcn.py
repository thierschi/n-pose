...
class CompactFCN(CustomFCN):
    def __init__(self, input_size: int, activation_fn=nn.ReLU, activation_params=None, inter_layer_module=None,
        ...
        layer_sizes = [input_size, input_size // 2, 128, 64, 6]
        super(CompactFCN, self).__init__(layer_sizes, activation_fn, activation_params, inter_layer_module,
